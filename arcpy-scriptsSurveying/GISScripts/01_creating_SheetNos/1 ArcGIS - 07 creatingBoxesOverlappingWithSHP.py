...
karnStateGeom = arcpy.da.SearchCursor(shpFile, ["SHAPE@"]).next()[0]
##print(karnStateGeom)
...
##        print(sheetNo)
##        print(polygon.extent.lowerLeft, karnStateGeom.extent.lowerLeft)
##        print(polygon.extent.upperLeft, karnStateGeom.extent.upperLeft)
##        print(polygon.extent.upperRight, karnStateGeom.extent.upperRight)
##        print(polygon.extent.lowerRight, karnStateGeom.extent.lowerRight)

##        pointsArray 

        if polygon.extent.overlaps(karnStateGeom.extent):
            print("extent touches")
        
        if polygon.touches(karnStateGeom):
            print ("touches")
